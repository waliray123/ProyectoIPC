...
public class Agua extends Planetas{
    ...
    public Agua(String NombrePlaneta, int porcentajeMuerte, int cantidadDinero, 
            int cantidadConstructores, int posicionX, int posicionY, 
            int cantidadNaves, int cantidadGuerreros) {
        super(NombrePlaneta, porcentajeMuerte, cantidadDinero, cantidadConstructores, 
                posicionX, posicionY, cantidadNaves, cantidadGuerreros);
    ...
    public void ProduccionGuerreros(int cantidadGuerrerosInicial){
        ...
        if (cantidadGuerrerosInicial != 0){
            ...
            cantidadGuerrerosProducir = (int) (Math.random() * 12 + 12);
        }
        ...
        for (int i = guerrerosDelPlaneta2.length; i < (guerrerosDelPlaneta2.length+cantidadGuerrerosProducir); i++) {
            this.guerrerosDelPlaneta[i] = new Nemo(this.porcentajeMuerte);
        }
    ...
    public void produccionDinero(){
        int cantidadProducidaDinero = (int)(Math.random() * 61 + 60);
